/**
 * @fileoverview eBook Part 2 — Carefree 20s & early, chapters 5-9. Extracted from ebook-pages.ts (T18).
 */
import type { BookPage } from './types';

export var part2Pages: BookPage[] = [

  /* ── Part 2 Title ── */
  { id: 'part2-title', type: 'part-title', pageNumber: 21, part: 2, title: 'Carefree 20s & early', subtitle: 'The scene years, the people, the business' },

  /* ── Chapter 5: Eighty-Six Hours ── */
  { id: 'ch5-title', type: 'chapter-start', pageNumber: 22, chapter: 5, title: 'Eighty-six hours', subtitle: 'A bus to Zambia, three border crossings, and three and a half minutes that rearranged everything.' },
  { id: 'ch5-content-1', type: 'chapter-content', pageNumber: 23, chapter: 5, paragraphs: [
  ...
  { id: 'ch5-content-2', type: 'chapter-content', pageNumber: 24, chapter: 5, paragraphs: [
  ...
  { id: 'ch5-content-3', type: 'chapter-content', pageNumber: 25, chapter: 5, paragraphs: [
  ...
  { id: 'ch5-content-4', type: 'chapter-content', pageNumber: 26, chapter: 5, paragraphs: [
  ...
  { id: 'ch5-content-5', type: 'chapter-content', pageNumber: 27, chapter: 5, paragraphs: [
  ...
  { id: 'ch6-title', type: 'chapter-start', pageNumber: 28, chapter: 6, title: 'The costume evolution', subtitle: 'From the Chicken Man to the Cow Man \u2014 and the identity that was building underneath.' },
  { id: 'ch6-content-1', type: 'chapter-content', pageNumber: 29, chapter: 6, paragraphs: [
  ...
  { id: 'ch6-content-2', type: 'chapter-content', pageNumber: 30, chapter: 6, paragraphs: [
  ...
  { id: 'ch6-content-3', type: 'chapter-content', pageNumber: 31, chapter: 6, paragraphs: [
  ...
  { id: 'ch6-content-4', type: 'chapter-content', pageNumber: 32, chapter: 6, paragraphs: [
  ...
  { id: 'ch7-title', type: 'chapter-start', pageNumber: 33, chapter: 7, title: 'The dancefloor gave me everything', subtitle: 'The people, the connections, the life built on 140 BPM.' },
  { id: 'ch7-content-1', type: 'chapter-content', pageNumber: 34, chapter: 7, paragraphs: [
  ...
  { id: 'ch7-content-2', type: 'chapter-content', pageNumber: 35, chapter: 7, paragraphs: [
  ...
  { id: 'ch7-content-3', type: 'chapter-content', pageNumber: 36, chapter: 7, paragraphs: [
  ...
  { id: 'ch7-content-4', type: 'chapter-content', pageNumber: 37, chapter: 7, paragraphs: [
  ...
  /* ── Chapter 8: LSD ── */
  { id: 'ch8-title', type: 'chapter-start', pageNumber: 38, chapter: 8, title: 'LSD', subtitle: 'LightSpeedDevelopment. The acronym was intentional.' },
  { id: 'ch8-content-1', type: 'chapter-content', pageNumber: 39, chapter: 8, paragraphs: [
  ...
  { id: 'ch8-content-2', type: 'chapter-content', pageNumber: 40, chapter: 8, paragraphs: [
  ...
  { id: 'ch9-title', type: 'chapter-start', pageNumber: 41, chapter: 9, title: 'Island time', subtitle: 'Thailand, the island that became a second home, and the road to 7,000 kilometres.' },
  { id: 'ch9-content-1', type: 'chapter-content', pageNumber: 42, chapter: 9, paragraphs: [
  ...
  { id: 'ch9-content-2', type: 'chapter-content', pageNumber: 43, chapter: 9, paragraphs: [
  ...
  { id: 'ch9-content-3', type: 'chapter-content', pageNumber: 44, chapter: 9, paragraphs: [
  ...
  { id: 'ch9-content-4', type: 'chapter-content', pageNumber: 45, chapter: 9, paragraphs: [
    'Koh Phangan became the training base. The third home, after Cape Town and Berlin.',
    'Morning routine: swim out to the coral reefs. Not laps in a pool \u2014 open water, salt water, fish darting beneath you, sea urchins in the rocks, the sun already hot at 7am. The swim is meditation and exercise simultaneously, the ADHD brain focused by the sensory richness of the ocean. It wasn\u2019t until 2019 that my swimming actually got good \u2014 after two years of training with Lourens Visser, who later joined LightSpeed as project manager. He turned me from someone who could survive in water into someone who could actually enjoy it. Now I swim out to the reefs for fun, not out of obligation.',
