...
export const pageSEO: Record<string, SEOData> = {
  ...
  artistry: {
    title: 'Global psytrance artist | Ash Shaw \u2014 UV makeup artistry',
    description:
      'The electric journey of a global psytrance makeup artist. From Cape Town to Berlin and Thailand \u2014 neon visions brought to life on the world\u2019s biggest dancefloors.',
  },
  ...
  tribes: {
    title: 'The tribes | Communities that shaped a neon soul \u2014 Ash Shaw',
    description:
      'The 12 tribes that define Ash Shaw \u2014 psytrance dancefloors, WordPress community, Berlin club scene, cycling, Muay Thai, LightSpeed, and more. A map of belonging across six continents.',
  },
