...
To update website content without touching code logic:

1.  **UI Text:** Edit files in `data/mock/ui/`.
2.  **Page Text:** Edit files in `data/mock/pages/`.
3.  **Blog Posts:** Edit `data/mock/blog/posts.ts`.
4.  **Portfolio Items:** Edit files in `data/mock/portfolio/`.
