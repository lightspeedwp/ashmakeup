import svgPaths from "./svg-c5gsmchi3l";
...
export default function SliderCard() {
  return (
    <div className="bg-[rgba(255,255,255,0.8)] relative rounded-[18.45px] size-full" data-name="SliderCard">
      ...
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[36px] items-start pb-px pt-[37px] px-[37px] relative size-full">
          <div className="h-[511.711px] overflow-clip relative rounded-[11.25px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.5),0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Container">
            ...
            <div className="absolute h-[34.5px] left-[353.31px] rounded-[1.67772e+07px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[13.5px] w-[144.898px]" data-name="Container" style={{ backgroundImage: "linear-gradient(166.607deg, rgb(255, 102, 204) 0%, rgb(153, 51, 255) 50%, rgb(51, 153, 255) 100%)" }}>
              <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[13.5px] not-italic text-[15.75px] text-nowrap text-white top-[6.75px]">Festival Makeup</p>
            </div>
          </div>
