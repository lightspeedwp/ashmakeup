...
function SidebarProvider({
  ...
  // This makes it easier to style the sidebar with CSS.
...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="sidebar sidebar-mobile-content"
          style={
            {
  ...
  return (
    <div
      className="group peer sidebar-desktop-host"
      data-state={state}
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium text-sidebar-foreground tabular-nums select-none pointer-events-none",
        className,
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  return (
    ...
    >
      {showIcon && (
        <Skeleton
          className="sidebar-skeleton-icon"
          data-sidebar="menu-skeleton-icon"
        />
      )}
      <Skeleton
        className="sidebar-skeleton-text"
